...
## How to install it
To install you should find the .apk file into the index directory, named "bmicalc-debug.apk, which can be installed on your device by enabling "Install from unknown sources" on it.